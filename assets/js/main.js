...
const shadowHeader = () => {
  ...
  // when scroll is greater than 50 viewport, add the scroll header class to the header tag
  this.scrollY >= 50
...
/*=============== NEW SWIPER ===============*/
let newFeatured = new Swiper(".new__swiper", {
  loop: true,
  spaceBetween: 16,
  slidesPerView: "auto",
...
const getCurrentIcon = () =>
  themeButton.classList.contains ? "ri-moon-line" : "ri-sun-line";
...
sr.reveal(`.discount__image`, { origin: "right" });
